...
class Magazento_Exportpage_Model_Mysql4_Item_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function addStoreFilter($store, $withAdmin = true) {
        ...
        $this->getSelect()->join(
                        array('item_store' => $this->getTable('exportpage/item_store')),
    ...
    public function addRelatedFilter($related) {
        ...
        $this->getSelect()->joinleft(
                        array('item_related' => $this->getTable('exportpage/item_related')),
