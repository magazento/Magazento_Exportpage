...
--
-- Table structure for table `magazento_exportpage_item`
--

CREATE TABLE IF NOT EXISTS {$this->getTable('magazento_exportpage_item')} (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('magazento_exportpage_item_related')}` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `related_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE IF NOT EXISTS `{$this->getTable('magazento_exportpage_item_store')}` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
